...
public class CropImageView extends FrameLayout {
    ...
    public void getCroppedImageAsync(CropShape cropShape, int reqWidth, int reqHeight) {
        ...
        mBitmapCroppingWorkerTask = mLoadedImageUri != null && mLoadedSampleSize > 1
                ? new WeakReference<BitmapCroppingWorkerTask>(new BitmapCroppingWorkerTask(this, mLoadedImageUri, getActualCropRectNoRotation(), cropShape, mDegreesRotated, reqWidth, reqHeight))
                : new WeakReference<BitmapCroppingWorkerTask>(new BitmapCroppingWorkerTask(this, mBitmap, getActualCropRect(), cropShape));
    ...
    public void setOnSetImageUriCompleteListener(OnSetImageUriCompleteListener listener) {
        mOnSetImageUriCompleteListener = listener != null ? new WeakReference<OnSetImageUriCompleteListener>(listener) : null;
    }
    ...
    public void setOnGetCroppedImageCompleteListener(OnGetCroppedImageCompleteListener listener) {
        mOnGetCroppedImageCompleteListener = listener != null ? new WeakReference<OnGetCroppedImageCompleteListener>(listener) : null;
    }
    ...
    private void setImageUriAsync(Uri uri, Integer preSetRotation) {
        if (uri != null) {
            ...
            clearImage(true);
            mCropOverlayView.setInitialCropWindowRect(null);
            mBitmapLoadingWorkerTask = new WeakReference<BitmapLoadingWorkerTask>(new BitmapLoadingWorkerTask(this, uri, preSetRotation));
